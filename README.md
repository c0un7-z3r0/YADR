...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/c0un7-z3r0/YADR/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/c0un7-z3r0/YADR/master/install.sh`" -s ask
```
